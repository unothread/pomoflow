...
const translations = {
  tr: {
    ...
    landingP1_2: "Pomodoro sayacı kullanmanın temel amacı, odaklanmayı artırmak ve zihinsel yorgunluğu azaltmaktır. Sürekli uzun saatler çalışmak yerine, beyni düzenli aralıklarla dinlendirerek gün boyu yüksek verimlilik elde edebilirsiniz.",
  ...
  en: {
    ...
    landingP1_2: "The main goal of using a Pomodoro timer is to increase focus and reduce mental fatigue. Instead of working continuously for long hours, resting your brain at regular intervals helps you achieve high productivity throughout the day.",
    ...
    landingSub1Desc: "In the modern age, distractions (notifications, emails, social media) are everywhere. Our minds are constantly \"context switching\", which leaves us exhausted by the end of the day. The Pomodoro technique offers you a simple contract: <em class='italic'>\"I will focus on just one thing for 25 minutes.\"</em> This short period is a reasonable enough goal to overcome procrastination.",
